...
# -------------------------------
# Step 1: Check and Install CustomTkinter
# Automatically installs CustomTkinter if missing
# -------------------------------
try:
    ...
    print("CustomTkinter installed! Restarting UI...")
    import customtkinter as ctk  # import again after installation

# -------------------------------
# Step 2: Import main CSV import function
# -------------------------------
from csvlistmaker import import_csv_to_youtube  # ensure this file is in the same folder
...
ctk.set_default_color_theme("green")  # Set color theme
...
class YouTubeCSVImporter(ctk.CTk):
    def __init__(self):
        ...
        self.btn_select_client = ctk.CTkButton(
            frame_client, 
        ...
        self.btn_select_csv = ctk.CTkButton(
            frame_csv, 
        ...
        self.log_output = scrolledtext.ScrolledText(self, width=90, height=20, bg="#1e1e1e", fg="white")
